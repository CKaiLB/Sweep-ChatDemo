...
(function() {
    ...
    const defaultConfig = {
        webhook: {
            url: localStorage.getItem('webhook_url') || '',
            route: '/chat'
        },
        branding: {
            logo: '',
            ...
            responseTimeText: '',
            poweredBy: {
                text: 'Powered by Sweep AI',
                link: 'https://sweepai.site'
            }
        },
        style: {
            primaryColor: '',
    ...
    if (!config.webhook.url) {
        console.error('Webhook URL not found. Please enter your access code first.');
        return;
    }
